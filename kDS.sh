...
/share/apps/libc6_2.17/lib/x86_64-linux-gnu/ld-2.17.so $(command -v /share/apps/python-3.6.0-shared/bin/python3) /cluster/project2/darkspeech/rob/DeepSpeech/test-tf.py


# GPU speed test script
#echo 'test script tf-GPU-test'
/share/apps/libc6_2.17/lib/x86_64-linux-gnu/ld-2.17.so $(command -v /share/apps/python-3.6.0-shared/bin/python3) /cluster/project2/darkspeech/rob/DeepSpeech/gpu-test-tf.py
...
#kDS
/share/apps/libc6_2.17/lib/x86_64-linux-gnu/ld-2.17.so $(command -v /share/apps/python-3.6.0-shared/bin/python3) /cluster/project2/darkspeech/rob/kDS/run-train.py 
